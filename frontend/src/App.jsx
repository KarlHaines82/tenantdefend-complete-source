        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center py-4">
            <div className="flex items-center space-x-3">
              <img src={logo} alt="TenantDefend" className="h-8 w-8" />
              <span className="text-xl font-bold text-red-800">TenantDefend</span>
            </div>
      ...
      <footer className="bg-gray-900 text-white py-8">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-center space-x-3">
            <img src={logo} alt="TenantDefend" className="h-6 w-6" />
            <span className="text-lg font-semibold">TenantDefend</span>
          </div>
          <p className="text-center text-gray-400 mt-4">
            © 2025 TenantDefend. Transforming tenant legal representation in Tennessee.
          </p>
        </div>
      </footer>
